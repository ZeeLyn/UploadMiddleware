            ...
            new Dictionary<string, List<(int, byte[])>>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                },
                {
                    ".mp4", new List<(int, byte[])>
                    {
                        ...
                        (4, new byte[] {0x66, 0x74, 0x79, 0x70, 0x69, 0x73, 0x6F, 0x6D}),
                        (4, new byte[] {0x66, 0x74, 0x79, 0x70, 0x4D, 0x53, 0x4E, 0x56})
                    }
                },
                {
                ...
                },
                {
                    ".zip", new List<(int, byte[])>
                    {
                        ...
                        (30, new byte[] {0x50, 0x4B, 0x4C, 0x49, 0x54, 0x45}),
                        (526, new byte[] {0x50, 0x4B, 0x53, 0x70, 0x58}),
                        (0, new byte[] {0x50, 0x4B, 0x05, 0x06}),
                        (0, new byte[] {0x50, 0x4B, 0x07, 0x08}),
                        //(29152, new byte[] {0x57, 0x69, 0x6E, 0x5A, 0x69, 0x70}),
                ...
                {
                    ".xls", new List<(int, byte[])>
                    {
                        (0, new byte[] {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1}),
                        (512, new byte[] {0x09, 0x08, 0x10, 0x00, 0x00, 0x06, 0x05, 0x00}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x10}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x1F}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x22}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x23}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x28}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x29})
                    }
                },
                {
                    ".xlsx", new List<(int, byte[])>
                    {
                        (0, new byte[] {0x50, 0x4B, 0x03, 0x04}),
                        (0, new byte[] {0x50, 0x4B, 0x03, 0x04, 0x14, 0x00, 0x06, 0x00})
                    }
                ...
                {
                    ".ppt", new List<(int, byte[])>
                    {
                        (0, new byte[] {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1}),
                        (512, new byte[] {0x00, 0x6E, 0x1E, 0xF0}),
                        (512, new byte[] {0x0F, 0x00, 0xE8, 0x03}),
                        (512, new byte[] {0xA0, 0x46, 0x1D, 0xF0}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x0E, 0x00, 0x00, 0x00}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x1C, 0x00, 0x00, 0x00}),
                        (512, new byte[] {0xFD, 0xFF, 0xFF, 0xFF, 0x43, 0x00, 0x00, 0x00})
                    }
                },
                {
                    ".pptx", new List<(int, byte[])>
                    {
                        (0, new byte[] {0x50, 0x4B, 0x03, 0x04}),
                        (0, new byte[] {0x50, 0x4B, 0x03, 0x04, 0x14, 0x00, 0x06, 0x00})
                    }
